...
openai_api_key = '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'
openai.api_key = openai_api_key


def generate_ai_news(name):
    prompt = f"Você é gerente do banco Santander.\n"
    prompt += f"Crie uma mensagem para o cliente {name} o parabenizando pelo seu aniversário (máximo de 100 caracteres)\n"
